...
export class EstadoCocherasComponent {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        try {
          ...
          Swal.fire('Eliminada', 'La cochera ha sido eliminada correctamente.', 'success');
        } catch (error) {
  ...
  cambiarDisponibilidadCochera(numeroFila: number, event: Event) {
    ...
    const opcion: string = cochera.deshabilitada ? "enable" : "disable"; 
